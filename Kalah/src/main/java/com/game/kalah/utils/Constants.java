...
public class Constants {
         ...
         public final static int MAX_NUMBER_OF_PITS = 14;
         public final static int STARTING_PIECES = 6;
         public final static int KALAH_1 = 6;
         public final static int KALAH_2 = 13;
         ...
         public final static String ERR_INDEX_PIT = "Pits only from 1 to " + MAX_NUMBER_OF_PITS + "!";
